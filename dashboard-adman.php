            ...
            <div class="row mt-5">
              <div class="col-lg-2 col-md-6 col-sm-6 mb-4 ">
                <div class="stats-small stats-small--1 card card-small">
                  <div class="card-body p-0 d-flex bg-light">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        <span class="stats-small__label text-uppercase">الاعلانات </span>
              ...
              <div class="col-lg-2 col-md-6 col-sm-6 mb-4">
                <div class="stats-small stats-small--1 card card-small">
                  <div class="card-body p-0 d-flex bg-light">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        <span class="stats-small__label text-uppercase">الصفحات </span>
              ...
              <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
                <div class="stats-small stats-small--1 card card-small">
                  <div class="card-body p-0 d-flex bg-light">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        <span class="stats-small__label text-uppercase">الكومنتات </span>
              ...
              <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
                <div class="stats-small stats-small--1 card card-small">
                  <div class="card-body p-0 d-flex bg-light">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        <span class="stats-small__label text-uppercase">المستخدمين </span>
              ...
              <div class="col-lg-2 col-md-4 col-sm-12 mb-4">
                <div class="stats-small stats-small--1 card card-small">
                  <div class="card-body p-0 d-flex bg-light">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        <span class="stats-small__label text-uppercase">المشتركين</span>
            ...
            <div class="row">
              ...
              <div class="col-lg-8 col-md-12 col-sm-12 mb-4">
                <div class="card card-small">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">المستخدمين</h6>
                  </div>
                  <div class="card-body pt-0">
                    <div class="row border-bottom py-2 bg-light">
                      <div class="col-12 col-sm-6">
                        <div id="blog-overview-date-range" class="input-daterange input-group input-group-sm my-auto ml-auto mr-auto ml-sm-auto mr-sm-0" style="max-width: 350px;">
                          <input type="text" class="input-sm form-control" name="start" placeholder="بدء التاريخ" id="blog-overview-date-range-1">
                          <input type="text" class="input-sm form-control" name="end" placeholder="انتهاء التاريخ" id="blog-overview-date-range-2">
                      ...
                      <div class="col-12 col-sm-6 d-flex mb-2 mb-sm-0">
                        <button type="button" class="btn btn-sm btn-white ml-auto mr-auto ml-sm-auto mr-sm-0 mt-3 mt-sm-0">عرض التقرير الكامل&rarr;</button>
                      </div>
                    </div>
              ...
              <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                <div class="card card-small h-100">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">المستخدمين من الاجهزة</h6>
                  </div>
                    ...
                    <div class="row">
                      <div class="col">
                        <select class="custom-select custom-select-sm" style="max-width: 130px;">
                          <option selected>الاسبوع الماضي </option>
                          <option value="1">اليوم</option>
                          <option value="2">الشهر الماضى </option>
                          <option value="3">السنة الماضية </option>
                        </select>
                      </div>
                      <div class="col text-right view-report">
                        <a href="#">تقرير كامل  &rarr;</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                ...
                <div class="card card-small h-100">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">مشروع جديد</h6>
                  </div>
                  <div class="card-body d-flex flex-column">
                    <form class="quick-post-form">
                      <div class="form-group">
                        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="عنوان جديد"> </div>
                      <div class="form-group">
                        <textarea class="form-control" placeholder="ادخل النص...."></textarea>
                      </div>
                      <div class="form-group mb-0">
                        <button type="submit" class="btn btn-accent">أنشاء مشروع </button>
                      </div>
                    </form>
                  </div>
                </div>
              ...
              <div class="col-lg-5 col-md-12 col-sm-12 mb-4">
                <div class="card card-small blog-comments">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">اقتراحات</h6>
                  </div>
                  <div class="card-body p-0">
                    <div class="blog-comments__item d-flex p-3">
                      <div class="blog-comments__avatar mr-3">
                        <img src="upload\avatars\1.jpg" alt="User avatar" /> </div>
                    ...
                    <div class="blog-comments__item d-flex p-3">
                      <div class="blog-comments__avatar mr-3">
                        <img src="upload\avatars\2.jpg" alt="User avatar" /> </div>
                      <div class="blog-comments__content">
                        <div class="blog-comments__meta text-muted">
                          <a class="text-secondary" href="#">James Johnson</a> on
                          <a class="text-secondary" href="#">Hello World!</a>
                    ...
                    <div class="blog-comments__item d-flex p-3">
                      <div class="blog-comments__avatar mr-3">
                        <img src="upload\avatars\3.jpg" alt="User avatar" /> </div>
                      <div class="blog-comments__content">
                        <div class="blog-comments__meta text-muted">
                          <a class="text-secondary" href="#">James Johnson</a> on
                          <a class="text-secondary" href="#">Hello World!</a>
                  ...
                  <div class="card-footer border-top">
                    <div class="row">
                      <div class="col text-center view-report">
                        <button type="submit" class="btn btn-white">عرض الكل </button>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="row">
                      <div class="col">
                        <select class="custom-select custom-select-sm">
                          <option selected>الاسبوع الماضي</option>
                          <option value="1">اليوم</option>
                          <option value="2">الشهر الماضي </option>
                          <option value="3">السنة الماضية </option>
                        </select>
                      </div>
                      <div class="col text-right view-report">
