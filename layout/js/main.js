...
$(function() {
  ...
  stringHeader = [
    '<span class="font-color-1 f-85">انجز </span>مشاريعك <br> بالاعتماد على <br> توظيف مستقلين <br> محترفين ',
    '<span class="font-color-1 f-85 ">الأن </span>موقع <br> شغلانه <br> لتوظيف المستقلين <br> المحترفين '
  ];
  /*End Header Section*/
  try {
