...
<div class="row px-5 mb-0 ">
    <div class="col-lg-8  col-sm-12 ">
           ...
           <div class="row">
            ...
            <div class="col-3">
                <img src="upload\cert\LuITT0KzYR_download.jpg" class="rounded w-100 h-100 position-relative" alt="...">
            </div>
             <div class="col-3">
                <img src="upload\cert\uxXoMtUm78_images.jpg" class="rounded w-100 h-100 position-relative" alt="...">
            </div>
