        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12">
                <div class="text-center mt-5 rounded bg-color-8 p-1 mb-4">
                    ...
                    $number_of_rows = $result->fetchColumn();
                    ?>
                    <a href="offers.php?do=manage&filt=all" class="hover2 d-block py-5 font-700 f-30 font-color-3">العروض <span><?= ($number_of_rows) ?></span></a>
                    <a href="offers.php?do=manage&filt=all" class="btn btn-lg btn-block mt-3 mb-0 font-color-2 bg-color-9">تصفح العروض</a>
                </div>
            </div>
            <div class="col-lg-4 col-sm-12">
                <div class="text-center my-3 bg-color-8 p-1">
                    ...
                    $number_of_rows = $result->fetchColumn();
                    ?>
                    <a href="offers.php?do=manage&filt=making" class="hover2 d-block py-2 font-700 f-24 font-color-3">عروض تحت الانشاء <span><?= ($number_of_rows) ?></span></a>
                </div>
            </div>
            <div class="col-lg-4 col-sm-12">
                <div class="text-center my-3 bg-color-8 p-1">
                    ...
                    $number_of_rows = $result->fetchColumn();
                    ?>
                    <a href="offers.php?do=manage&filt=finsh" class="hover2 d-block py-2 font-700 f-24 font-color-3">عروض منتهيه <span><?= ($number_of_rows) ?></span></a>
                </div>
            </div>
            <div class="col-lg-4 col-sm-12">
                <div class="text-center my-3 bg-color-8 p-1">
                    ...
                    $number_of_rows = $result->fetchColumn();
                    ?>
                    <a href="offers.php?do=manage&filt=cansel" class="hover2 d-block py-2 font-700 f-24 font-color-3">عروض بأنتظار الرد <span><?= ($number_of_rows) ?></span></a>
                </div>
            </div>
            <div class="col-lg-4 col-sm-12">
                <div class="text-center my-3 bg-color-8 p-1">
