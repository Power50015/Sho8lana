                ...
                <form class="login col-lg-6 col-sm-12 col-xs-12 d-block p-5 mt-5 rounded mb-5" action="<?=($_SERVER['PHP_SELF'])?>" method="POST">
                    <div class="form-group pt-1 pb-2">
                        <input type="name"
                               name="name" 
                               required 
                               class="form-control rounded-0 px-3 py-3 font-cairo" 
                               aria-describedby="emailHelp"
                               placeholder="الأسم"
                               pattern=".{4,}"
                               title="يجب ان لا يقل اسم المستخدم عن 4 حروف"/>
                    </div>
                    <div class="form-group pt-1 pb-2">
                        <input type="email" 
                               name="email" 
                    ...
                    <div class="form-group pt-2">
                        <input type="password" 
                               ...
                               minlength="10"
                               title="يجب ان لا يقل الرقم السى عن 10 حروف"/>
                    </div>
                    <div class="form-group pt-1">
                        <input type="password" 
                               ...
                               required 
                               class="form-control rounded-0 px-3 py-3 font-cairo" 
                               placeholder="اعادة كتابة الرقم السري"
                               minlength="10"/>
                    </div>
