...
<header id='fullHeader'>
    ...
    <div class="container pt-5 position-relative">
        <h2 class="bg-color-3 d-inline-block px-3 py-1 f-30 font-cairo text-light"> تواصل معنا </h2> 
            <div class="row justify-content-center mt-3">
                <form class="login col-lg-6 col-sm-12 col-xs-12 d-block p-5 mt-5 rounded mb-5" >
                    <div class="form-group pt-3 pb-2">
                        <input type="name" name="name" required class="form-control rounded-0 px-3 py-3 font-cairo" placeholder="الاسم ">
                    </div>
